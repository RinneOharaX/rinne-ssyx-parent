...
public class RedisDateUtil {
    ...
    public static boolean dateCompare(Date beginDate, Date endDate) {
        // endDate > beginDate
        if (RedisDateUtil.truncatedCompareTo(beginDate, endDate, Calendar.SECOND) == 1) {
            return false;
        }
        return true;
    }
    ...
    public static boolean timeCompare(Date beginDate, Date endDate) {
        ...
        // endDate > beginDate
        if (RedisDateUtil.truncatedCompareTo(instance1.getTime(), instance2.getTime(), Calendar.SECOND) == 1) {
            return false;
        }
        return true;
    }
