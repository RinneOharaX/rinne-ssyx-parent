package com.rinneohara.ssyx.common.code;
...
public class CodeGet {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("C:\\Users\\Administrator\\Desktop\\sys_manage\\code\\rinne-ssyx-parent\\service-system"+"/src/main/java");
        ...
        dsc.setPassword("zxy902");
        dsc.setDbType(DbType.MYSQL);
        mpg.setDataSource(dsc);

        // 4、包配置
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.rinneohara.ssyx");
